$(document).ready(function () {
  ...
  function createTeam(data) {
    ...
    var name1 = $("<p>")
      .html(`<b>Team: </b> ${data.fullName}--(${data.key})`)
      .attr({
        class: "name-team",
      });
    var cham1 = $("<p>")
      .html(`<b>Championship Won : </b> ${data.championshipsWon}`)
      .attr({
        class: "cham-team",
      });
    var play1 = $("<p>")
      .html(`<b> No. Of Players: </b> ${data.players.length}`)
      .attr({
        class: "play-team",
      });
...
var teamData = [
  ...
  },
  {
    ...
    championshipsWon: 1,
    teamIcon:
      "https://upload.wikimedia.org/wikipedia/hi/thumb/6/60/Rajasthan_Royals_Logo.svg/1200px-Rajasthan_Royals_Logo.svg.png",
    players: [
      {
        id: "1",
        name: "Jos Buttler",
